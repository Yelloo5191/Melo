...
const NavBar = () => {
  ...
  const ChakraAnchorLink = chakra(AnchorLink);
            ...
            <Nav className="mr-auto" navbar data-testid="navbar-items">
              ...
              {user && (
                <>
                  ...
                  <NavItem>
                    <PageLink href="/dashboard" className="nav-link" testId="navbar-dshb">
                      Dashboard
                    </PageLink>
                  </NavItem>
                </>
              ...
              {!isLoading && !user && (
                <NavItem id="qsLoginBtn">
                  <ChakraAnchorLink
                    ...
                    backgroundColor="brand.logo.background"
                    _hover={{ backgroundColor: 'brand.logo.light' }}
                    border="0"
                    borderRadius={10}
                    tabIndex={0}
